 ...
 * @author it16169036
 */
public class NewPOGarment extends javax.swing.JFrame {

    public static boolean edit;
    
    /**
     * Creates new form NewPOGarment
     */
    public NewPOGarment(boolean edt,String pk) {
        initComponents();
        ...
        edit=edt;
        jLabel1.setText("EDIT GARMENT PURCHASE ORDER");
        ...
        try {    
            ResultSet rs1 = dbCon.con.createStatement().executeQuery("SELECT * FROM splgarment WHERE portionNo ='"+pk+"'");
            while(rs1.next()){
                jComboBox4.addItem(rs1.getString("customer"));
                jComboBox1.addItem(rs1.getString("portionNo"));
                jComboBox2.addItem(rs1.getString("style"));
                jComboBox3.addItem(rs1.getString("color"));
                jComboBox5.addItem(rs1.getString("pktListNo"));
                jComboBox7.addItem(rs1.getString("item"));
                jComboBox6.addItem(rs1.getString("totQty"));
            }
                    
            ResultSet rs2 = dbCon.con.createStatement().executeQuery("SELECT * FROM pogarment WHERE portionNo ='"+pk+"'");
            while(rs2.next()){
            ...
            Logger.getLogger(NewPOGarment.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public NewPOGarment() {
        ...
        try {   
            ResultSet rs1 = dbCon.con.createStatement().executeQuery("SELECT DISTINCT pktListNo FROM splgarment WHERE PO_Status=0");
            while(rs1.next()){
                jComboBox5.addItem(rs1.getString("pktListNo"));
            }
            
            ResultSet rs2 = dbCon.con.createStatement().executeQuery("SELECT MAX(poNo) as po FROM pogarment");
            if(rs2.next()){
    ...
    private void initComponents() {
        ...
        jLabel1.setText("ADD GARMENT PURCHASE ORDER");
        ...
        jLabel11.setText("Tot Qty Pieces");
        getContentPane().add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 330, 100, 30));

        jLabel12.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel12.setText("Unit Price/Piece");
        getContentPane().add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 330, 100, 30));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if( jComboBox6.getSelectedIndex() ==  -1 ){
            JOptionPane.showMessageDialog(jComboBox5, "Select Total Quantity", "Error", JOptionPane.ERROR_MESSAGE);
        }
        else{
            int x = Integer.parseInt(jTextField11.getText());
            int y = Integer.parseInt(String.valueOf(jComboBox6.getSelectedItem()));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
      ...
      try { 
        if(edit==false){
                ...
                dbCon.con.prepareStatement("INSERT INTO pogarment VALUES("+pon+",'"+pd+"','"+sd+"',"+uc+","+tc+",'"+pn+"')").execute();
                dbCon.con.prepareStatement("UPDATE splgarment SET PO_Status = 1 WHERE portionNo = '"+pn+"'").execute();
                JOptionPane.showMessageDialog (jComboBox5, "New Garment Purchase Order Added Successfully", "Done", JOptionPane.INFORMATION_MESSAGE);
            ...
            dbCon.con.prepareStatement("UPDATE pogarment SET expDate='"+sd+"',unitCost="+uc+",totCost="+tc+" WHERE poNo="+pon+"").execute();
                JOptionPane.showMessageDialog (jComboBox5, "Garment Purchase Order Updated Successfully", "Done", JOptionPane.INFORMATION_MESSAGE);
    ...
    private void jComboBox5ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jComboBox5ItemStateChanged
        ...
        try {
            ...
            ResultSet rs = dbCon.con.createStatement().executeQuery("SELECT DISTINCT customer FROM splgarment WHERE pktListNo='"+data+"' AND PO_Status=0");
            while(rs.next()){
    ...
    private void jComboBox4ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jComboBox4ItemStateChanged
        ...
        try {
            ...
            ResultSet rs = dbCon.con.createStatement().executeQuery("SELECT DISTINCT portionNo FROM splgarment WHERE pktListNo='"+data+"' AND customer='"+data2+"' AND PO_Status=0");
            while(rs.next()){
                jComboBox1.addItem(rs.getString("portionNo"));
            }
            jComboBox1.setSelectedIndex(-1);
            jComboBox2.setSelectedIndex(-1);
            jComboBox3.setSelectedIndex(-1);
    ...
    private void jComboBox1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jComboBox1ItemStateChanged
        ...
        try {
            ...
            jComboBox7.removeAllItems();
            jComboBox6.removeAllItems();
            ResultSet rs = dbCon.con.createStatement().executeQuery("SELECT DISTINCT style,color,item,totQty  FROM splgarment WHERE pktListNo='"+data+"' AND customer='"+data2+"' AND portionNo='"+data3+"'");
            while(rs.next()){
                jComboBox2.addItem(rs.getString("style"));
                jComboBox3.addItem(rs.getString("color"));
                jComboBox7.addItem(rs.getString("item"));
                jComboBox6.addItem(rs.getString("totQty"));
            }
            ...
            if(new methods().validateDateBackward(new SimpleDateFormat("dd-MM-yyyy").format(Date.getDate()), jLabel10)){
                if((jComboBox5.getSelectedIndex())!= -1){
                    if((jComboBox4.getSelectedIndex())!= -1){
                            ...
                            if((jComboBox2.getSelectedIndex())!= -1){
                                if((jComboBox3.getSelectedIndex())!= -1){
                                    if((jComboBox7.getSelectedIndex())!= -1){
                                        ...
                                        jLabel10.setText("Select Total Quantity Pieces");
                                        return false;
                                        }
                                }else{
                                    ...
                                    jLabel10.setText("Select a Item");
                                    return false;
                                    }   
                            }else{
                        ...
                        jLabel10.setText("Select a Portion Number");
                        return false;
                        }
                }else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NewPOGarment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

 ...
 * @author Ranmal
 */
public class NewPOGlove extends javax.swing.JFrame {
    
    
    public static boolean edit;

    /**
     * Creates new form NewPOGlove
     */
    public NewPOGlove(boolean edt,String pk) {
        initComponents();
        ...
        edit=edt;
        jLabel1.setText("EDIT GLOVE PURCHASE ORDER");
        ...
        try {    
            ResultSet rs1 = dbCon.con.createStatement().executeQuery("SELECT * FROM splglove WHERE lotNo ='"+pk+"'");
            while(rs1.next()){
                jComboBox4.addItem(rs1.getString("customer"));
                jComboBox1.addItem(rs1.getString("batchNo"));
                jComboBox2.addItem(rs1.getString("style"));
                jComboBox3.addItem(rs1.getString("size"));
                jComboBox5.addItem(rs1.getString("pktListNo"));
                jComboBox6.addItem(rs1.getString("totQtyPrs"));
            }
                    
            ResultSet rs2 = dbCon.con.createStatement().executeQuery("SELECT * FROM poglove WHERE lotNo ='"+pk+"'");
            while(rs2.next()){
            ...
            Logger.getLogger(NewPOGlove.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public NewPOGlove() {
        ...
        try {   
            ResultSet rs1 = dbCon.con.createStatement().executeQuery("SELECT DISTINCT pktListNo FROM splglove WHERE PO_Status=0");
            while(rs1.next()){
                jComboBox5.addItem(rs1.getString("pktListNo"));
            }
            
            ResultSet rs2 = dbCon.con.createStatement().executeQuery("SELECT MAX(poNo) as po FROM poglove");
            if(rs2.next()){
     ...
     public boolean formValidate() {
            ...
            if(new methods().validateDateBackward(new SimpleDateFormat("dd-MM-yyyy").format(Date.getDate()), jLabel10)){
                if((jComboBox5.getSelectedIndex())!= -1){
                    if((jComboBox4.getSelectedIndex())!= -1){
                        if((jComboBox1.getSelectedIndex())!= -1){
                            if((jComboBox2.getSelectedIndex())!= -1){
                                if((jComboBox3.getSelectedIndex())!= -1){
                                        ...
                                        jLabel10.setText("Select Total Quantity Pairs");
                                        return false;
                                        }
                                }else{
                                    ...
                                    jLabel10.setText("Select a Size");
                                    return false;
                                    }   
                            }else{
                        ...
                        jLabel10.setText("Select a Lot Number");
                        return false;
                        }
                }else{
    ...
    private void initComponents() {
        ...
        jLabel1.setText("ADD GLOVE PURCHASE ORDER");
        ...
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 70, 60, 30));
        ...
        getContentPane().add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 330, 50, 30));
        ...
        getContentPane().add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 360, 120, 30));

        jLabel8.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel8.setText("Style");
        getContentPane().add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 330, 50, 30));

        jLabel9.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel9.setText("Size");
        getContentPane().add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 330, 50, 30));
        ...
        getContentPane().add(jComboBox3, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 360, 90, 30));

        jLabel11.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel11.setText("Total Qty Pairs");
        getContentPane().add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 330, 100, 30));
        ...
        getContentPane().add(jComboBox2, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 360, 100, 30));
        ...
        getContentPane().add(jTextField11, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 360, 110, 30));

        jLabel12.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel12.setText("Unit Price/Qty");
        getContentPane().add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 330, 90, 30));

        jTextField12.setEditable(false);
        getContentPane().add(jTextField12, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 440, 130, 30));

        jLabel13.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel13.setText("Total Cost :-");
        getContentPane().add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 440, 90, 30));
        ...
        getContentPane().add(jComboBox6, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 360, 110, 30));

        jLabel10.setForeground(new java.awt.Color(255, 0, 0));
        getContentPane().add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 250, 300, 50));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if( jComboBox6.getSelectedIndex() ==  -1 ){
            JOptionPane.showMessageDialog(jComboBox5, "Select Total Quantity Pairs", "Error", JOptionPane.ERROR_MESSAGE);
        }
        else{
    ...
    private void jComboBox5ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jComboBox5ItemStateChanged
        ...
        try {
            ...
            ResultSet rs = dbCon.con.createStatement().executeQuery("SELECT DISTINCT customer FROM splglove WHERE pktListNo='"+data+"' AND PO_Status=0");
            while(rs.next()){
    ...
    private void jComboBox4ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jComboBox4ItemStateChanged
       if(edit==false){
        try {
            ...
            ResultSet rs = dbCon.con.createStatement().executeQuery("SELECT DISTINCT lotNo FROM splglove WHERE pktListNo='"+data+"' AND customer='"+data2+"' AND PO_Status=0");
            while(rs.next()){
                jComboBox1.addItem(rs.getString("lotNo"));
            }
            jComboBox1.setSelectedIndex(-1);
            jComboBox2.setSelectedIndex(-1);
            jComboBox3.setSelectedIndex(-1);
    ...
    private void jComboBox1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jComboBox1ItemStateChanged
        ...
        try {
            ...
            jComboBox6.removeAllItems();
            ResultSet rs = dbCon.con.createStatement().executeQuery("SELECT DISTINCT style,size,totQtyPrs FROM splglove WHERE pktListNo='"+data+"' AND customer='"+data2+"' AND lotNo='"+data3+"'");
            while(rs.next()){
                jComboBox2.addItem(rs.getString("style"));
                jComboBox3.addItem(rs.getString("size"));
                jComboBox6.addItem(rs.getString("totQtyPrs"));
            }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String ln = String.valueOf(jComboBox1.getSelectedItem());
      ...
      try { 
        if(edit==false){
                ...
                dbCon.con.prepareStatement("INSERT INTO poglove VALUES("+pn+",'"+pd+"','"+sd+"',"+uc+","+tc+",'"+ln+"')").execute();
                dbCon.con.prepareStatement("UPDATE splglove SET PO_Status = 1 WHERE lotNo = '"+ln+"'").execute();
                JOptionPane.showMessageDialog (jComboBox5, "New Gloves Purchase Order Added Successfully", "Done", JOptionPane.INFORMATION_MESSAGE);
            ...
            dbCon.con.prepareStatement("UPDATE poglove SET expDate='"+sd+"',unitCost="+uc+",totCost="+tc+" WHERE poNo="+pn+"").execute();
                JOptionPane.showMessageDialog (jComboBox5, "Gloves Purchase Order Updated Successfully", "Done", JOptionPane.INFORMATION_MESSAGE);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NewPOGlove.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NewPOGlove().setVisible(true);
            }
        });
    }

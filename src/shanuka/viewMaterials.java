 ...
 * @author it16175358
 */
public class viewMaterials extends javax.swing.JPanel {
     ...
     */
    public viewMaterials() throws SQLException {
        initComponents();
        ...
        updateMax("SELECT COUNT(*) AS count FROM material");
        addTable("SELECT * FROM material LIMIT " + lim + " OFFSET " + offset + "");
    }
    ...
    void addTable(String query) {
        try {
            ...
            DefaultTableModel model = new DefaultTableModel(new Object[]{"material", "category", "unit", "color", "description"}, 0);
            while (rs.next()) {
                String ch = rs.getString("materialNo");
                String na = rs.getString("category");
                String qt = rs.getString("unit");
                //String col = rs.getString("color");

                String cl = rs.getString("color");
                String des = rs.getString("description");
                Object[] row = {ch, na, qt, cl, des};
                model.addRow(row);
            }
    ...
    void search() throws SQLException {
        ...
        if (sh.equals("")) {
            ...
            String q = "SELECT * FROM material WHERE materialNo like '%" + sh + "%'";
            addTable(q);
        }
    }
    ...
    private void initComponents() {
        ...
        search.setText("search material#");
        ...
        jPanel1.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 110, 50, 30));
        ...
        jPanel1.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 110, 100, 30));
        ...
        jButton2.setText("+  Add New Material");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        Home.material.setVisible(false);
    ...
    private void editActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editActionPerformed
        ...
        try {
            ...
            addMaterial a = new addMaterial(s);
            a.setVisible(true);
        } catch (SQLException ex) {
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
        ...
        int dialogResult = JOptionPane.showConfirmDialog(null, "Selected material will be deleted", "Warning", dialogButton);

        if (dialogResult == 0) {
            try {
                con.prepareStatement("DELETE FROM material WHERE materialNo='" + s + "'").execute();

                //delete size,color,recipes
                JOptionPane.showMessageDialog(null, "Material deleted", "Done", JOptionPane.INFORMATION_MESSAGE);
                updateMax("SELECT COUNT(*) AS count FROM material");
                addTable("SELECT * FROM material LIMIT " + lim + " OFFSET " + offset + "");
            } catch (SQLException ex) {
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        // TODO add your handling code here:
        Home.Report(jTable1, "Material Details","E:\\Reports\\vmaterial.pdf");

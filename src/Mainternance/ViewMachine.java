 ...
 * @author it16175358
 */
public class ViewMachine extends javax.swing.JPanel {
    ...
    public ViewMachine() throws  SQLException{
        initComponents();
        //loadData();
       ...
       con= db.ConnectDB();
        ...
        updateMax("SELECT COUNT(*) AS count FROM machine");
        addTable("SELECT * FROM machine LIMIT "+lim+" OFFSET "+offset+"");
    ...
    private void initComponents() {
        ...
        jPanel2.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 150, 910, 250));
        ...
        jPanel2.add(edit, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 420, -1, 30));
    ...
    void addTable(String query) {
        try {
            ...
            DefaultTableModel model = new DefaultTableModel(new Object[]{"machinerefno","machinename","manufacturer","dateofpurchase","department","status"}, 0);
            while (rs.next()) {
                ...
                Object[] row = {machrefno,machname,manu,Date,dept,status};                   
                model.addRow(row);                   
            }
    ...
    void search() throws SQLException{
        ...
        if(sh.equals("")){
            ...
            String q = "SELECT * FROM machine WHERE machinerefno like '%"+sh+"%' or machinename like '%"+sh+"%'";
            addTable(q);
        }
    }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        Home.ViewMachine.setVisible(false);
    ...
    private void editActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editActionPerformed
        ...
        String manu = (String) jtabmachine.getValueAt(r, 2);
        String Date = (String) jtabmachine.getValueAt(r, 3);
        String dept = (String) jtabmachine.getValueAt(r, 4);
        String status = (String) jtabmachine.getValueAt(r, 5);
        
        AddMachine a = new AddMachine(machrefno,machname,manu,Date,dept,status);
        a.setVisible(true);
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
        ...
        int dialogResult = JOptionPane.showConfirmDialog (null, "Machine will be deleted","Warning",dialogButton);
        
        if(dialogResult==0){
            try {
                con.prepareStatement("DELETE FROM machine WHERE machinerefno = '"+machrefno+"' AND machinename ='"+machname+"' AND manufacturer = '"+manu+"'AND dateofpurchase ='"+Date+"' AND department = '"+dept+"' AND status ='"+status+"' ").execute();
                JOptionPane.showMessageDialog (null, "machine deleted", "Done", JOptionPane.INFORMATION_MESSAGE);
                updateMax("SELECT COUNT(*) AS count FROM machine");
                addTable("SELECT * FROM machine LIMIT "+lim+" OFFSET "+offset+"");
            } catch (SQLException ex) {
                Logger.getLogger(ViewMachine.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void editMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_editMouseClicked
        // TODO add your handling code here:
        AddMachine e =new AddMachine();
     //   editm.setVisible(true);
     //   submit.setVisible(true);
    }//GEN-LAST:event_editMouseClicked

    private void printActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_printActionPerformed
        Home.Report(jtabmachine, "Machine List","E:\\Reports\\machinelist.pdf");

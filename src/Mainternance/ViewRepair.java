...
public class ViewRepair extends javax.swing.JPanel {
    ...
    public ViewRepair() throws SQLException {
        initComponents();
       ...
       con= db.ConnectDB();
        ...
        updateMax("SELECT COUNT(*) AS count FROM repair");
        addTable("SELECT * FROM repair LIMIT "+lim+" OFFSET "+offset+"");
    ...
    private void initComponents() {
        ...
        jtabmachine.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Machine Reference No", "Machine Name", "Equipment Name", "Frequency", "Date of Repair", "Department", "status"
            }
        ));
        ...
        jPanel2.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 60, 120, 30));
        ...
        jPanel2.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 60, 170, 30));
  ...
  void addTable(String query) {
       try {
            ...
            DefaultTableModel model = new DefaultTableModel(new Object[]{"machinerefno","machname","equipmentname","frequency","dateofrepair","department","status"}, 0);
            while (rs.next()) {
                ...
                String Date = rs.getString("dateofrepair");
                String dept = rs.getString("department");
                String status = rs.getString("status");
                
               
                Object[] row = {machrefno,machname,equiname,freq,Date,dept,status};                   
                model.addRow(row);                   
            }
            jtabmachine.setModel(model);
        } catch (SQLException ex) {
            Logger.getLogger(ViewRepair.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    void search() throws SQLException{
        ...
        if(sh.equals("")){
            ...
            String q = "SELECT * FROM repair WHERE machinerefno like '%"+sh+"%' or machinename like '%"+sh+"%'";
            addTable(q);
        }
    }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        Home.ViewRepair.setVisible(false);
    ...
    private void editActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editActionPerformed
        ...
        String machrefno = (String) jtabmachine.getValueAt(r, 0);
        String machname = (String) jtabmachine.getValueAt(r, 1);
        String equiname = (String) jtabmachine.getValueAt(r, 2);
        String freq = (String) jtabmachine.getValueAt(r, 3);
        String Date = (String) jtabmachine.getValueAt(r, 4);
        String dept = (String) jtabmachine.getValueAt(r, 5);
        String status = (String) jtabmachine.getValueAt(r, 6);
        
        AddRepair a = null;
         try {
             a = new AddRepair(machrefno,machname,equiname,freq,Date,dept,status);
         } catch (SQLException ex) {
             Logger.getLogger(ViewRepair.class.getName()).log(Level.SEVERE, null, ex);
         }
        a.setVisible(true);
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
        ...
        int dialogResult = JOptionPane.showConfirmDialog (null, " Repair Machine will be deleted","Warning",dialogButton);
        
        if(dialogResult==0){
            try {
                con.prepareStatement("DELETE FROM repair WHERE machinerefno = '"+machrefno+"' AND machinename ='"+machname+"' AND equipmentname = '"+equiname+"'AND frequency ='"+freq+"' AND dateofrepair ='"+Date+"' AND department = '"+dept+"' AND status ='"+status+"' ").execute();
                JOptionPane.showMessageDialog (null, "Repair deleted", "Done", JOptionPane.INFORMATION_MESSAGE);
                updateMax("SELECT COUNT(*) AS count FROM repair");
                addTable("SELECT * FROM repair LIMIT "+lim+" OFFSET "+offset+"");
            } catch (SQLException ex) {
                Logger.getLogger(ViewRepair.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void printActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_printActionPerformed
        Home.Report(jtabmachine, "Repair List","E:\\Reports\\repairlist.pdf");
...
public void loadData() {
   ...
   try {
            ...
            while (rs.next()) {
                ...
                v.add(rs.getString("machinename"));
                v.add(rs.getString("equipmentname"));
                v.add(rs.getString("frequency"));
                v.add(rs.getString("dateofrepair"));

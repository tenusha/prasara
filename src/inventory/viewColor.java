 ...
 * @author Tenusha
 */
public class viewColor extends javax.swing.JPanel {
     ...
     */
    public viewColor() throws SQLException {
        initComponents();
        ...
        updateMax("SELECT COUNT(*) AS count FROM color");
        addTable("SELECT * FROM color LIMIT " + lim + " OFFSET " + offset + "");
    }
    ...
    void addTable(String query) {
        try {
            ...
            DefaultTableModel model = new DefaultTableModel(new Object[]{"Customer", "Style", " Color Code", "Color Name"}, 0);
            while (rs.next()) {
                String col = rs.getString("color");
                String colName = rs.getString("colorName");
                String cus = rs.getString("customer");
                String stl = rs.getString("style");

                Object[] row = {cus, stl, col, colName};
                model.addRow(row);
            }
    ...
    void search() throws SQLException {
        ...
        if (sh.equals("")) {
            ...
            String q = "SELECT * FROM color WHERE customer like '%" + sh + "%' or style like '%" + sh + "%' or color like '%" + sh + "%' or colorName like '%" + sh + "%'";
            addTable(q);
        }
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(jButton6, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 420, 30, 30));
        ...
        jPanel1.add(jButton7, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 420, 30, 30));
        ...
        jPanel1.add(page, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 420, 30, 30));

        jLabel9.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(255, 255, 255));
        jLabel9.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel9.setText("/");
        jPanel1.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 420, 30, 30));

        total.setForeground(new java.awt.Color(255, 255, 255));
        total.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jPanel1.add(total, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 420, 30, 30));
        ...
        jPanel1.add(jButton8, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 420, 30, 30));
        ...
        jPanel1.add(jButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 420, 30, 30));
        ...
        jPanel1.add(edit, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 420, -1, 30));
    ...
    private void editActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editActionPerformed
        ...
        String cus = (String) jTable1.getValueAt(r, 0);
        String stl = (String) jTable1.getValueAt(r, 1);
        String col = (String) jTable1.getValueAt(r, 2);
        try {
            addColor a = new addColor("edit", cus, stl, col);
            a.setVisible(true);
        } catch (SQLException ex) {
            Logger.getLogger(viewColor.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
        ...
        int dialogResult = JOptionPane.showConfirmDialog(null, "Style color will be deleted", "Warning", dialogButton);

        if (dialogResult == 0) {
            try {
                con.prepareStatement("DELETE FROM color WHERE customer = '" + cus + "' AND style ='" + stl + "' AND color = '" + col + "' ").execute();
                JOptionPane.showMessageDialog(null, "Style color deleted", "Done", JOptionPane.INFORMATION_MESSAGE);
                refresh();
            } catch (SQLException ex) {
                Logger.getLogger(viewColor.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        // TODO add your handling code here:
        Home.Report(jTable1, "Style Color Details","E:\\Reports\\styleColor.pdf");

...
public class viewSize extends javax.swing.JPanel {
     ...
     */
    public viewSize() throws SQLException {
        initComponents();
        ...
        updateMax("SELECT COUNT(*) AS count FROM size");
        addTable("SELECT * FROM size LIMIT " + lim + " OFFSET " + offset + "");
    }
    ...
    void addTable(String query) {
        try {
            ...
            DefaultTableModel model = new DefaultTableModel(new Object[]{"Customer", "Style", "Size"}, 0);
            while (rs.next()) {
                String siz = rs.getString("size");
                String cus = rs.getString("customer");
                String stl = rs.getString("style");

                Object[] row = {cus, stl, siz};
                model.addRow(row);
            }
    ...
    void search() throws SQLException {
        ...
        if (sh.equals("")) {
            ...
            String q = "SELECT * FROM size WHERE customer like '%" + sh + "%' or style like '%" + sh + "%' ";
            addTable(q);
        }
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Size Data");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 13, 372, -1));

        jSeparator3.setBackground(new java.awt.Color(204, 204, 204));
        jPanel1.add(jSeparator3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 470, 920, 13));

        jSeparator2.setBackground(new java.awt.Color(204, 204, 204));
        jPanel1.add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 0, 920, 13));
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
        ...
        String size = (String) jTable1.getValueAt(r, 2);

        int dialogButton = JOptionPane.YES_NO_OPTION;
        int dialogResult = JOptionPane.showConfirmDialog(null, "Style size will be deleted", "Warning", dialogButton);

        if (dialogResult == 0) {
            try {
                con.prepareStatement("DELETE FROM size WHERE customer = '" + cus + "' AND style ='" + stl + "' AND size = '" + size + "' ").execute();
                JOptionPane.showMessageDialog(null, "Style size deleted", "Done", JOptionPane.INFORMATION_MESSAGE);
                refresh();
            } catch (SQLException ex) {
                Logger.getLogger(viewColor.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        // TODO add your handling code here:
        Home.Report(jTable1, "Style Size Details","E:\\Reports\\styleSize.pdf");

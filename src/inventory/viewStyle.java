 ...
 * @author Tenusha
 */
public class viewStyle extends javax.swing.JPanel {
    ...
    /**
     * Creates new form viewStyle
     */
    public viewStyle() throws SQLException {
        initComponents();
        ...
        updateMax("SELECT COUNT(*) AS count FROM style");
        addTable("SELECT * FROM style LIMIT " + lim + " OFFSET " + offset + "");
    }
    ...
    void addTable(String query) {
        try {
            ...
            DefaultTableModel model = new DefaultTableModel(new Object[]{"Style", "Customer", "Type", "Method", "Description"}, 0);
            while (rs.next()) {
                String st = rs.getString("styleNo");
                String cus = rs.getString("customer");
                String ty = rs.getString("type");
                String m = rs.getString("method");
                String des = rs.getString("description");
                Object[] row = {st, cus, ty, m, des};
                model.addRow(row);
            }
    ...
    void search() throws SQLException {
        ...
        if (sh.equals("")) {
            ...
            String q = "SELECT * FROM style WHERE styleNo like '%" + sh + "%' or customer like '%" + sh + "%' or type like '%" + sh + "%' or method like '%" + sh + "%'";
            addTable(q);
        }
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 160, 910, 240));
        ...
        jPanel1.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 120, 50, 30));
        ...
        jPanel1.add(limit1, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 120, 60, 30));

        jLabel11.setForeground(new java.awt.Color(255, 255, 255));
        jLabel11.setText("results per page");
        jPanel1.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 120, 100, 30));
        ...
        jButton2.setText("+  Add New Style");
        ...
        jPanel1.add(edit, new org.netbeans.lib.awtextra.AbsoluteConstraints(855, 420, -1, 30));
        ...
        jPanel1.add(delete, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 420, 100, 30));
    ...
    private void editActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editActionPerformed
        ...
        String cu = (String) jTable1.getValueAt(r, 1);
        try {
            addStyle a = new addStyle("edit", s, cu);
            a.setVisible(true);
        } catch (SQLException ex) {
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
        ...
        String s = (String) jTable1.getValueAt(r, 0);
        String cu = (String) jTable1.getValueAt(r, 1);
        String co = (String) jTable1.getValueAt(r, 3);

        int dialogButton = JOptionPane.YES_NO_OPTION;
        int dialogResult = JOptionPane.showConfirmDialog(null, "All data of selected style will be deleted", "Warning", dialogButton);

        if (dialogResult == 0) {
            try {
                con.prepareStatement("DELETE FROM style WHERE customer='" + cu + "' AND styleNo='" + s + "'").execute();
                con.prepareStatement("DELETE FROM color WHERE customer = '" + cu + "' AND style ='" + s + "'").execute();
                con.prepareStatement("DELETE FROM recipe WHERE styleNo='" + s + "' AND customer = '" + cu + "' ").execute();
                con.prepareStatement("DELETE FROM size WHERE customer = '" + cu + "' AND style ='" + s + "'").execute();
                ResultSet ga = con.createStatement().executeQuery("SELECT * FROM style WHERE styleNo='" + s + "'");
                if (ga.next()) {
                } else {
                    con.prepareStatement("DELETE FROM garments WHERE style ='" + s + "'").execute();
                }

                JOptionPane.showMessageDialog(null, "Style deleted", "Done", JOptionPane.INFORMATION_MESSAGE);
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        // TODO add your handling code here:
        Home.Report(jTable1, "Style Details","E:\\Reports\\style.pdf");
